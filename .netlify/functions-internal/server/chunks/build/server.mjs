...
import { u as parseURL, f as encodePath, d as decodePath, n as hasProtocol, o as isScriptProtocol, r as joinURL, y as withQuery, v as sanitizeStatusCode, h as getContext, $ as $fetch, c as createError$1, g as executeAsync, b as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-D4QiNYaz.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BK8m5dp2.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Cg106079.mjs'));
